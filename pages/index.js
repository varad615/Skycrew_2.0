...
import Logo from "../public/SkyCrewLogoWhite.png";
            ...
            <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
              ...
              <div class="text-center lg:w-2/3 w-full">
                ...
                <p class="mb-8 leading-relaxed">
                  SkyRocket your Skills by building Epic Stuff
                </p>
                <div class="flex justify-center">
                  <Link href="/signin">
                    <button class="text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-l focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                      Lets get started
                    </button>
                  </Link>
                </div>
